...
| 12 | Give this event a short label that tells the implementer what to build. |
| 17 | Choose a start and end between frames 0 and 239. The end frame itself is not included. |
...
| 11 | Mark beats, cues, and input windows without naming engine methods. |
...
| 7 | The scene sets the planning context. |
| 6 | It does not show app output. |
| 10 | Prompt and source details are recorded in the product’s visual thesis. |
...
| Frame-data handoff | Adapter JSON |
