...
Open <https://animatic-event-strip.sociobot.in/demo> or choose **Try it with sample data** on the first screen.

The demo starts with a 10-second, 24 fps scene called **Rain Gate — opening beat**. Its six events cover two board ranges, one waveform snippet, a visual beat, an interaction window, and an implementation note. The labels and notes show a realistic animator-to-engine handoff.
