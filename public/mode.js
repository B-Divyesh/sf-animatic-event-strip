(() => {
  ...
  if (demo) {
    ...
    document.querySelector('link[rel="canonical"]')?.setAttribute('href', 'https://animatic-event-strip.sociobot.in/?demo=1');
    document.querySelector('meta[property="og:title"]')?.setAttribute('content', 'Demo — Animatic Event Strip');
    document.querySelector('meta[property="og:url"]')?.setAttribute('content', 'https://animatic-event-strip.sociobot.in/?demo=1');
